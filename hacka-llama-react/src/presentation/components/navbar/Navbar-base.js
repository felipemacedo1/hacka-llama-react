  ...
  return (
    <header className="bg-gray-900 text-white p-4 flex justify-between items-center">
      ...
      <nav className="flex-1 text-center space-x-4">
        ...
        <Link to="/notas" className="hover:underline">
          Notas e Faltas
        </Link>
        <Link to="/carreira" className="hover:underline">
          Minha Carreira
        </Link>
        <Link to="/avaliacoes" className="hover:underline">
          Avaliação de Desafios
        </Link>
        <Link to="/dashboard" className="hover:underline">
          Dashboard
        </Link>
        <Link to="/apoio" className="hover:underline">
        ...
        <div className="relative">
          ...
          {notificationMenuOpen && (
            <div className="absolute right-0 mt-2 w-64 bg-white rounded-md shadow-lg py-2 z-20">
              ...
              >
                Tarefa 1: Estudar React
              </Link>
              <Link
                to="/tarefa2"
                className="block px-4 py-2 text-gray-800 hover:bg-gray-200"
              >
                Tarefa 2: Completar exercícios de matemática
              </Link>
              <Link
                to="/tarefa3"
                className="block px-4 py-2 text-gray-800 hover:bg-gray-200"
              >
                Tarefa 3: Ler capítulo 4 do livro de história
              </Link>
            </div>
          )}
        </div>
