...
function Header() {
  return (
    <div
      className="w-full px-10 text-dark-60/100 flex py-2"
      style={{ backgroundColor: 'rgba(3, 30, 42, 1)' }}
    >
      <div className="container mx-10 flex justify-between items-center text-[24px] justify-between flex mx-4">
        <Link to="/home" className="text-[22px] font-bold">
          Dashboard
        </Link>
        ...
        <div className="flex items-center gap-2 cursor-pointer ">
          <span>
            <Trophy size={32} color="gold" weight="fill" />
          </span>
