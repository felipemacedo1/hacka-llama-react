  ...
  <div className="w-full bg-gray-200 rounded-full h-1.5 mb-4 dark:bg-gray-700">
    ...
    <div className="flex justify-between items-center">
      ...
      <div className="flex flex-col items-center">
        <button
          className="flex items-center justify-center bg-blue-600 text-white w-80 h-16 rounded-lg"
        >
        ...
        <p className="text-sm text-gray-400 mt-2">Ver minhas Formações e Planos de Estudo</p>
      </div>
    </div>
  </div>
</div>
