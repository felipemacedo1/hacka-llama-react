...
const Dashboard: React.FC = () => {
  ...
  const statistics = [
    ...
    { title: "Saúde e Bem-Estar", value: "82%", percentual: 3, bgColor: "bg-green-100" },
    { title: "Metas Concluídas", value: 134, percentual: 5, bgColor: "bg-pink-100" },
  ];
  ...
  return (
    <div className="p-4 px-8">
      ...
      <div className="flex flex-col md:flex-row items-start justify-around mb-8">
        {/* Imagem de destaque */}
        <div className="flex items-center" style={{ marginLeft: "-65px", paddingTop: "15px" }}>
          <img
        ...
        <div className="w-full md:w-3/5 mt-6 bg-white shadow-md rounded-lg p-6">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-start">
              <h1 className="text-6xl font-mono font-bold text-yellow-400 mr-4">9</h1>
              <div>
                <h4 className="text-base font-medium text-gray-600">Aula atual:</h4>
                <h3 className="text-2xl font-semibold text-gray-800">Matemática</h3>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-500 mt-2">Ver minhas Formações e Planos de Estudo</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <section className="flex flex-col md:flex-row">
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 md:ml-6">
          ...
          <PieChartDashboard data={pieChartData} colors={COLORS} title="Desempenho Geral" />
        </div>
      </section>
    </div>
  );
