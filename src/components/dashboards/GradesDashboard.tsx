...
const gradesData = {
  labels: ['Matemática', 'História', 'Ciências', 'Física', 'Química', 'Geografia'],
  datasets: [{
...
const GradesDashboard: React.FC = () => {
  return (
    <div className="bg-dark-60 p-6 rounded-xl shadow-lg max-w-4xl mx-auto mt-10">
      <h3 className="text-2xl font-semibold text-gray-800 mb-4">Média das Notas</h3>
      <Bar data={gradesData} options={{
        responsive: true,
        plugins: {
          tooltip: {
